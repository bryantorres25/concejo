        ...
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    ...
                    <h5 class="text-white op-7 mb-2">Hojas de Vida</h5>
                </div>
                                        ...
                                        <div class="col-12 col-sm-7 col-md-3">
                                            <div class="card border border-success">
                                                <div class="card-body">
                                                    ...
                                                    <p class="text-center"><a class="btn btn-success" href="{{route('hojas-vida.show',$item->id)}}" ><img
                                                        src="{{asset('img/anadir.png')}}" alt="" width="50px"></a></p>
