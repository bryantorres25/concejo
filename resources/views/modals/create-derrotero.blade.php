<div id="ModalDerrotero" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_create"  name="form_create" action="{{ route('derrotero.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                   @include('form.derrotero', ['crear'=>true, 'editar'=>false])
