    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_edit" name="form_edit" action="{{ route('partidos.update', 'partido') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    @include('form.partido', ['crear'=>false, 'editar'=>true])                    
            </div>
