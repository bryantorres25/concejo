...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div>
                <select name="tipoeleccion_id" id="tipoeleccion_id" class="form-control" required>
                    <option value="" selected="selected"> - Seleccione - </option>
                    @foreach ($tipoelecciones as $item)
...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-6">
            <label>Telefono</label>
            <input type="text" name="telefono" id="telefono_e" class="form-control"  />
        </div>
    </div>
</div>
