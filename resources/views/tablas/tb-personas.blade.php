		...
		<tbody>
            @foreach ($personas as $persona)
                <tr>
                    ...
                    <td>{{ $persona->comision->nombre }}</td>
                    <td><img src="fotos/{{$persona->foto}}" alt="" width="60px" ></td>
                    <td>{{ $persona->correo }}</td>
                    <td><img src="logos/{{$persona->partido->logo }}" alt="" width="64px" ></td>
                    <td>
                        @if($persona->estado)
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-warning waves-effect waves-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Opciones</button>
                            <div class="dropdown-menu">
                                ...
                                data-documento="{{$persona->documento}}" data-genero="{{$persona->genero}}" data-telefono="{{$persona->telefono}}" data-direccion="{{$persona->direccion}}" data-correo="{{$persona->correo}}"
                                data-cargo_id="{{$persona->cargo_id}}" data-partido_id="{{$persona->partido_id}}" data-comision_id="{{$persona->comision_id}}" data-fecha_nac="{{$persona->fecha_nac}}" data-target="#modalEdit"><i class="fa fa-edit"></i> Actualizar</a>
