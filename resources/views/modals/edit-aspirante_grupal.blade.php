    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_edit" name="form_edit" action="{{ route('aspirantes-grupales.update', 'aspirante-grupal') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    @include('form.aspirantegrupal', ['crear'=>false, 'editar'=>true])                    
            </div>
