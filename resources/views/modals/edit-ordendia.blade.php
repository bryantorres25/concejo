    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_edit" name="form_edit" action="{{ route('ordendia.update', 'ordendia') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    @include('form.ordendia', ['crear'=>false, 'editar'=>true])
            </div>
