...
<div class="panel-header" style="background-color: #B43437">
	...
	<form id="form_hidden" style="display:none" action="{{route('recursos.index')}}" method="GET"><input type="hidden" name="opcion" value="ok"></form>
	@include('modals.create-recurso')
	@include('modals.edit-recurso')
	@endsection
	...
	<script src="{{ asset('archivos_js/Recursos.js') }}"></script>
@endsection
