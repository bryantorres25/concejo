    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_create" name="form_create" action="{{ route('aspirantes.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                   @include('form.aspirante', ['crear'=>true, 'editar'=>false])   
