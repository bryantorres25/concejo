...
<div class="panel-header" style="background-color: #B43437">
        ...
        <div class="row mt--2">
            <div class="col-md-12">
				<div class="card full-height">
					<div class="card-body">
                    <div class="col-md-12">
								<form id="form_filtro" action="{{ route('elecciones.filtro') }}" class="form-inline" >
	...
	<form id="form_hidden" style="display:none" action="{{route('elecciones.index')}}" method="GET"><input type="hidden" name="opcion" value="ok"></form>
    ...
    <script src="{{ asset('archivos_js/Elecciones.js') }}"></script>
