...
class ProyectoVotacionController extends Controller
{
    /**
    ...
    {
        $votaciones=ProyectoVotacion::all();
    ...
    {
        $obj = ProyectoVotacion::findOrFail($id);
