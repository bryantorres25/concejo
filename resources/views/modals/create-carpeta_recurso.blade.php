<div id="ModalCarpetas" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_create" action="{{ route('carpetas-recursos.store') }}" method="POST">
                    @csrf
                   @include('form.carpeta_recurso', ['crear'=>true, 'editar'=>false])   
