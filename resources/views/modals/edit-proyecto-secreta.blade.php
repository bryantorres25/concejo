    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_edit" name="form_edit" action="{{ route('proyectos-secretos.update', 'proyecto') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    @include('form.proyecto-secreta', ['crear'=>false, 'editar'=>true])
            </div>
