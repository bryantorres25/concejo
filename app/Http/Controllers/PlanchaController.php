...
class PlanchaController  extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('planchas.index',compact('nombreplanchas','comisiones','planchas','cantidad_persona','cantidad_plancha'));
    }
    ...
    public function show($id)
    {
        ...
        return view('planchas.show',compact('idplancha','comisiones','nombre_plancha'));
    }
