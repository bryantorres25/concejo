    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
			<div>
				...
				<h5 class="text-white op-7 mb-2">Orden del Dia</h5>
			</div>
						...
						<div class="row">
							@foreach ($ordendia as $item)
								<div class="col-sm-6 col-md-3">
									<a class="stretched-link text-decoration-none nav-link " href="archivos_ordendia/{{ $item->ruta }}" target="_blank"  aria-haspopup="true" aria-expanded="false">
											...
											<div class="card-body ">
												<div class="row">
													...
													<div class="col-7 col-stats">
														<div class="numbers">
															<p class="card-title">Orden del dia:</p>
