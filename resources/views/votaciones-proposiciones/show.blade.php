	...
	<div class="card  card-round">
        ...
        <div class="card-body ">
            ...
            <div class="row">
				...
				<div class="col-md-8">
                    <form action="{{ route('votaciones-proposiciones.store') }}" method="POST" id="form_votacion">
                        @csrf
                        <input type="hidden" name="proposicion_id" value="{{ $item->proposicion_id }}">
                        <input type="hidden" name="respuesta" id="respuesta" >
						<div class="card card-white  card-round card ">
							<div class="card-body text">
								<div class="pricing-header">
                                    <h2 class="fw-bold">PROPOSICION POR: <b>{{ $item->proposicion->nombre }}</b></h2>
                                    <h2 class="fw-bold"><b>{{ $item->proposicion->descripcion }}</b></h2>
...
@endsection
@section('scripts')
    <script src="{{ asset('archivos_js/VotacionProposicion.js') }}"></script>
@endsection
