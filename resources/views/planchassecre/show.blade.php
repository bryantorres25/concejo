    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
			<div>
				...
				<h5 class="text-white op-7 mb-2">Detalles de planchas</h5>
			</div>
				...
				<div class="card full-height">
                    ...
                    <div class="col-md-12">
                        <h2 class="text-danger">Detalles de: {{$nombre_plancha}}</h2>
                                <form id="form_filtro" action="{{ route('planchas-secre.filtro') }}" class="form-inline" >
									...
									<button type="button" id="buscar" class="btn btn-success"><i class="fa fa-search"></i> Ver Personas</button>&nbsp;&nbsp;

                                     <a href="{{ route('planchas-secre.index') }}" class="btn btn-warning"> Regresar a planchas</a>
