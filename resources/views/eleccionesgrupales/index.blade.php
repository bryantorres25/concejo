...
<div class="panel-header" style="background-color: #B43437">
    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
			<div>
				...
				<h5 class="text-white op-7 mb-2">Elecciones </h5>
			</div>
        ...
        <div class="row mt--2">
            <div class="col-md-12">
				<div class="card full-height">
					<div class="card-body">
                    <div class="col-md-12">
								<form id="form_filtro" action="{{ route('elecciones-grupales.filtro') }}" class="form-inline" >
									<div class="form-group">
                                        <label>Tipo de Eleccion</label>
                                        <div>
                                            <select name="eleccionsocial_id" id="eleccionsocial_id" class="form-control" >
                                                    <option value="0">Seleccionar</option>
                                                    @foreach ($eleccionessociales as $item)
	...
	<form id="form_hidden" style="display:none" action="{{route('elecciones-grupales.index')}}" method="GET"><input type="hidden" name="opcion" value="ok"></form>
    ...
    <script src="{{ asset('archivos_js/Eleccionesgrupales.js') }}"></script>
